...
void solve() {
    ...
    for (int i = 2 ; i < n ; i++) {
        ...
        else if (a1 == 0 and a2 == 0 and a3 == 0) {
            ans += 3;
        }

        else if (a1 == 0 and a2 == 1 and a3 == 1) {
            ans += 2;
        }
        else if (a1 == 0 and a2 == 1 and a3 == 0) {
            ans += 1;
        }

        else if (a2 == 0 and a1 == 1 and a3 == 1) {
            ans += 2;
        }
        else if (a2 == 0 and a1 == 1 and a3 == 0) {
            ans += 1;
        }
